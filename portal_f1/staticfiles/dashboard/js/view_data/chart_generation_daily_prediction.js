$(document).ready(function(){
    const endpoint = 'api/energy/daily/prediction'
    const cores = ['#7CFC00', '#434FF7', '#FF0000']
    const units = [' MWh']
    const chart = ['bar']
    ...
    function updateChart() {
      ...
      $.ajax({
        method: "GET",
        url: `${endpoint}?date=${$("#date_reference").val()}`,
